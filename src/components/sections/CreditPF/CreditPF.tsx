...
// Dados do conteúdo
const contentData = {
  sectionTitle: "S O L U Ç Õ E S",
  sectionSubtitle: "Para Você",
  sectionDescription:
    "Soluções de Crédito Personalizadas para Pessoas Físicas: Financiamentos e Linhas de Crédito com Garantia, Desenvolvidas para Atender às Suas Necessidades de Aquisição, Reestruturação e Crescimento Patrimonial.",
      ...
      <Container>
        <Row className="justify-content-center align-items-center px-4 ">
          <div className="col-md-7 mb-4">
            <p className="m-0 text-highlight fw-bold">
              {contentData.sectionTitle}
            </p>
            <h2 className="text-medium mt-0 mb-4">
              {contentData.sectionSubtitle}
            </h2>
            <p className="">{contentData.sectionDescription}</p>
          </div>
